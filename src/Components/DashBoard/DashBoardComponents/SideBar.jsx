...
export default function SideBar() {
            ...
            if (user) {
                ...
                try {
                    ...
                    if (adminDocSnapshot.exists()) {
                        ...
                        setRole(adminDocSnapshot.data().role);
                    } else {
    ...
    return (
        <>
            ...
            <aside id="logo-sidebar" className="hidden md:block fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full border-r sm:translate-x-0 bg-gray-800 border-gray-700" aria-label="Sidebar">
                    ...
                    <ul className="space-y-2 font-medium">
                        ...
                        <li>
                            <a href="#" className="flex items-center p-2 rounded-lg text-white hover:bg-gray-700 group">
                                ...
                                <span className="inline-flex items-center justify-center w-3 h-3 p-3 ml-3 text-sm font-medium rounded-full bg-blue-900 text-blue-300">3</span>
                            </a>
                        </li>
                        <li>
                            <a href="#" className="flex items-center p-2 rounded-lg text-white hover:bg-gray-700 group">
                    ...
                    <ul className="space-y-2 text-white font-medium mt-14">
                        ...
                        <li>
                            <a href="#" className="flex items-center p-2 rounded-lg text-white hover:bg-gray-700 group">
                                ...
                                <span onClick={handleLogOut} className="flex-1 ml-3 whitespace-nowrap">Log out</span>
                            </a>
                        </li>
                    </ul>
                </div>
