export default function UserCard({ distributorName, email }) {
    return (
        <>
                        ...
                        <li className="py-3 sm:py-4">
                            <div className="flex items-center space-x-4">
                                <div className="flex-shrink-0">
                                    <img className="w-8 h-8 rounded-full" src="https://cs12.pikabu.ru/post_img/big/2022/10/24/2/1666571824193118478.jpg" alt="Neil image" />
                                </div>
                                <div className="flex-1 min-w-0">
                                    ...
                                    <p className="mt-2 text-sm text-gray-500 truncate dark:text-gray-400">
                                        {email ? email : `${distributorName}@gmail.com` }
                                    </p>
                                </div>
